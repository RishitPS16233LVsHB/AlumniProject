...
<%
    ...
    if (Request["id"] != null)
    {
        ...
        connection.Open();
        string Query1 = "update tbl_user set is_enabled = 'y' where user_id = " + Request["id"] + "";
        ...
        SendMail("User Verification", "Congratulations dear user you have been verified and ready to be part of our community...you will be able to login using your registered password and enrollment number", new string[] { user_email });
