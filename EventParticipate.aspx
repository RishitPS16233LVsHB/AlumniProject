<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EventParticipate.aspx.cs" Inherits="AlumniProject.EventParticipate" %>
                ...
                if (!string.IsNullOrEmpty(Session["user_id"].ToString()))
                {
                    if (EventID > 0)
                    {
                        ...
                        else
                        {
                            ...
                            Response.Write("<script>alert('participated in event');document.location.href='Events.aspx';</script>");
                        }
