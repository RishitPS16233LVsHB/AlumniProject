<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CancelApplication.aspx.cs" Inherits="AlumniProject.CancelApplication" %>
...
<%
    ...
    else
    {
        ...
        if (!string.IsNullOrEmpty(Request["job_apply_id"]))
        {
            string ID = Request["job_apply_id"];
            MySqlConnection connection = ConnectToDB();
            connection.Open();
            string query = "update tbl_job_apply set is_enabled = 'n' where job_apply_id = " + ID + "";
