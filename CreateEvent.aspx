<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CreateEvent.aspx.cs" Inherits="AlumniProject.CreateEvent" %>
<!DOCTYPE html>
                    ...
                    if (fileUploadControl.FileName != null && fileUploadControl.FileName != "")
                    {
                        ...
                        if (fileUploadControl.FileName != null && fileUploadControl.FileName != "")
                        {
                            if (rx.IsMatch(fileUploadControl.FileName))
                            {
                                ...
                                Response.Write("<script>alert('event created successfully');document.location.href='Events.aspx';</script>");
                            }
                            else
