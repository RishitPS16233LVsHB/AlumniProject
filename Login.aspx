...
<body>
    ...
    <div class="container">
        ...
        <div class="content">
            <form action="LoginPageValidations.aspx" method="get" runat="server">
                <div class="user-details">
                    
                    <div class="input-box">
                        <span class="details">Enrollment Number</span>
                        <input type="text" name="email" id="email" placeholder="Enter your enrollment number" runat="server" required/>
                    </div>
                ...
                <a href="ForgotPassword.aspx" style="color:red; text-decoration:none;">Forgot Password?</a>
            </form>
        </div>
    </div>
